...
export default function PublicListingPage() {
  ...
  const l = listing;
  const effectiveAgentPhone = (sender && sender.phone) || overridePhone || l.agent_phone;
  const effectiveAgentName = (sender && sender.name) || overrideName || l.agent_name;
    ...
    <div style={sx.page}>
      ...
      <div style={sx.body}>
        ...
        <div style={sx.ctaRow}>
          ...
          <a href={`https://wa.me/${waNumber}`} target="_blank" rel="noopener noreferrer" style={sx.waBtn}><WhatsAppLogo size={24} /> WhatsApp</a>
        </div>
        ...
        {/* Агент — тот, кто прислал ссылку (или агент объекта) */}
