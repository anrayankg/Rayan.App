...
export default function AgentListingPage() {
  ...
  // "Поделиться" всегда ведёт на КЛИЕНТСКУЮ страницу (/p/...) — клиент не увидит комиссию.
  // Если агент вошёл в кабинет — в ссылке будет ЕГО номер и имя.
    ...
    <div style={sx.page}>
      ...
      <div style={sx.body}>
        ...
        <AgentContactBlock name={l.agent_name} phone={l.agent_phone}
          waText={`Здравствуйте, я по поводу объекта Id: ${l.display_id || id}\n${agentPageUrl}`} />
