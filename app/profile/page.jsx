...
const sx = {
  ...
  headerCard: { display: "flex", alignItems: "center", gap: 12, background: "rgba(255,255,255,0.045)",
    border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, padding: "16px 16px" },
  avatar: { width: 52, height: 52, borderRadius: "50%", background: "rgba(31,163,92,0.18)", color: "#5BD98A",
  ...
  logoutBtn: { background: "none", border: "1px solid rgba(255,255,255,0.15)", color: "#8B8B90",
    fontSize: 12, padding: "8px 13px", borderRadius: 9, flexShrink: 0 },
  sectionTitle: { fontSize: 12.5, fontWeight: 700, color: "#7FA396", textTransform: "uppercase",
    letterSpacing: 0.5, marginTop: 28, marginBottom: 12, paddingTop: 4, borderTop: "1px solid rgba(255,255,255,0.07)" },
  emptyMsg: { color: "#8B8B90", fontSize: 13, lineHeight: 1.6 },
  grid: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10 },
  card: { textDecoration: "none", color: "#fff", background: "rgba(255,255,255,0.04)", borderRadius: 12,
    overflow: "hidden", paddingBottom: 8, border: "1px solid rgba(255,255,255,0.06)" },
  ...
  cardPrice: { fontSize: 13, fontWeight: 800, margin: "8px 9px 0" },
  cardMeta: { fontSize: 10, color: "#8B8B90", margin: "2px 9px 0", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
